...
export default function App() {
  return (
    <>
      ...
      <SVGIcon variant="face" width="50px" />
      <SVGIcon variant="heart" width="50px" color="green" />
      <button>
        <SVGIcon variant="heart" width="50px" color="green" />
      </button>
    </>
...
// might use https://pictogrammers.com/library/mdi/icon/heart/ as svg source, very cool
